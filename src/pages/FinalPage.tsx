    ...
    return (
        <div className="flex flex-col gap-8 justify-center items-center bg-white h-screen w-screen">
            <div>
                ...
                <p className="text-black text-xl fade-in-third">Anche se tu non ci vuoi bene, <span className="text-red-500">noi te ne vogliamo</span></p>
            </div>
            <img src={gifUrl} alt="Grazie Riccardo" className="w-1/3 h-auto fade-in-second rounded-lg" />
